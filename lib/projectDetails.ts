  ...
  */
  {
    ...
    summaryMore: [
      "모델 구조를 바꾸는 대신 학습 데이터를 새로 만들고 다듬어 성능을 올리는 쪽을 택했습니다. 수천 장 규모의 초음파 영상을 선별해 GT를 작성하고 기존 GT의 품질을 보정했습니다. 이렇게 만든 데이터가 지금 제품에 탑재된 난포 검출 모델의 학습 데이터로 쓰이고 있습니다. 제가 학습시킨 모델 자체는 채택되지 않았지만, 성능을 올리기 위해 만든 데이터는 남아 지금도 쓰이고 있습니다.",
    ],
        ...
        solutionBlocks: [
          ...
          },
          {
            ...
            points: [
              ...
              "수천 장 중 학습에 쓸 영상을 선별 — 고른 영상에는 GT를 새로 그려 학습 데이터로 만듦",
