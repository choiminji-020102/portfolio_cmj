...
export const careers: Career[] = [
  ...
  },
  {
    ...
    /*
      ...
      ①~⑤는 파트 1(2024.03~04, 다중 구조물 검출) — 상세 페이지가 있다.
      ⑥은 파트 2(2024.05~08, AddCaliper) — 상세는 자료가 오면 별도 slug 로 추가한다.

      순서는 중요도순이다. 시간순으로 놓으면 도구 구현이 앞서고 원인 규명이
      맨 뒤로 밀리는데, 카드에서 끝까지 읽히는 줄은 위 두세 개뿐이다.
